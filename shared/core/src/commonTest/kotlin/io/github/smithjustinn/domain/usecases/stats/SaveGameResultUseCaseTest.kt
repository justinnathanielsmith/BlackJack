...
class SaveGameResultUseCaseTest {
    ...
    @Test
    fun testInvoke_newBestScore() = runTest {
        val pairCount = 8
        val score = 100
        val time = 60L
        val moves = 20
    ...
    @Test
    fun testInvoke_notBestScore() = runTest {
        val pairCount = 8
        val score = 50
        val time = 100L
        val moves = 20
    ...
    @Test
    fun testInvoke_betterScore_worseTime() = runTest {
        val pairCount = 8
        val score = 200
        val time = 100L
        val moves = 20
    ...
    @Test
    fun testInvoke_worseScore_betterTime() = runTest {
        val pairCount = 8
        val score = 50
        val time = 40L
        val moves = 20
    ...
    @Test
    fun testInvoke_initialBestTimeZero() = runTest {
        val pairCount = 8
        val score = 50
        val time = 40L
        val moves = 20
    ...
    @Test
    fun testInvoke_repositoryFailure_handlesException() = runTest {
        val pairCount = 8
