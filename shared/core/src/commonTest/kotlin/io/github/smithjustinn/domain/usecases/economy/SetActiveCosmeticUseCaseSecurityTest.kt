...
class SetActiveCosmeticUseCaseSecurityTest {
    ...
    @Test
    fun `should prevent equipping locked items`() =
        runTest {
    ...
    @Test
    fun `should allow equipping unlocked items`() =
        runTest {
    ...
    @Test
    fun `should allow equipping default items even if not explicitly unlocked`() =
        runTest {
