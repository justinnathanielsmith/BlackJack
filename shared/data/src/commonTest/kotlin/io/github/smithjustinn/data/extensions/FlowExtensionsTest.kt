...
class FlowExtensionsTest {
    ...
    @Test
    fun testMapToStateFlowEagerly() = runTest(UnconfinedTestDispatcher()) {
        val sourceFlow = MutableSharedFlow<Int>()
        val stateFlow = sourceFlow.mapToStateFlow(
    ...
    @Test
    fun testMapToStateFlowLazily() = runTest(UnconfinedTestDispatcher()) {
    ...
    @Test
    fun testMapToStateFlowTransform() = runTest(UnconfinedTestDispatcher()) {
    ...
    @Test
    fun testMapToStateFlowWithFlowOf() = runTest(UnconfinedTestDispatcher()) {
